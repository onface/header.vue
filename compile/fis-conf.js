                ...
                var html = markrun(content, {
                    compile: {
                        code: function (source, data, info) {
                            ...
                            if (typeof settings.run === 'string') {
                                sourcePath = settings.run
                            }
                            if (fis.project.currentMedia() === 'dev') {
                                scriptCode = `
                                <script data-markrun-lastrun="true">
                                document.write('<scri' + 'pt src="${sourcePath}?v=${iPackage.version}"' + '" ></sc' + 'ript>')
                                </script>
                                `
                            }
                            else {
                                scriptCode = `<script data-markrun-lastrun="true" src="${sourcePath}?v=${iPackage.version}"></script>`
                            }
